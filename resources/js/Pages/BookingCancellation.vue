        ...
        <div class="mx-auto max-w-3xl">
            <div class="overflow-hidden rounded-3xl border border-stone-200 bg-white">
                ...
                <section class="px-6 py-8 sm:px-10">
                    ...
                    <BookingCancellationSummary :summary="summary" />
...
import { BookingCancellationSummary } from '@/components';
import type { BookingCancellationPageProps } from '@/types';

const props = defineProps<BookingCancellationPageProps>();
