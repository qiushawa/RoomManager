<template>
    <div class="z-20 min-h-[88px] p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] h-[88px]">
        <div class="flex h-full w-full items-center justify-between gap-0">
            <div v-if="currentStep === 1" class="flex w-auto flex-row items-center gap-4">
                <div class="flex items-center gap-2">
                    ...
                    <DatePicker :formatted-date="formattedDate" :date-string="currentDateString"
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 text-xs text-gray-500">
                    <span class="flex items-center gap-1">
                        <span class="h-2.5 w-2.5 rounded-sm border border-gray-300 bg-success"></span>
                        選取中
                    </span>
                    <span class="flex items-center gap-1">
                    ...
                    <span class="flex items-center gap-1">
                        <span class="h-2.5 w-2.5 rounded-sm border border-gray-300 bg-white"></span>
                        可申請
                    </span>
                </div>
            </div>
